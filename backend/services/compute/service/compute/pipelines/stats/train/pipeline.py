...
class ClassifierTrainingPipeline(Pipeline):
    ...
    def run(self, params):
        ...
        print('Excluding columns {}'.format(exclude_columns))
...
def run_training_fold(storage_id, train, test, index_column, target_column, exclude_columns, token):
    ...
    try:
        ...
        print('Loading features from file {} with index column {}'.format(file_path, index_column))
        features = load_features(file_path, index_col=index_column)
        print('Converting to Numpy array with target column {}, excluding {}'.format(target_column, exclude_columns))
